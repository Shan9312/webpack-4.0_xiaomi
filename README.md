...
2.npm i webpack webpack-cli -D // webpack4中除了正常安装webpack之外，需要再单独安一个webpack-cli
...
3.创建一个webpack.config.js // webpack是基于Node的
如下：
module.exports = {
    entry: '',               // 入口文件
    output: {},              // 出口文件
...
4.npm i webpack-dev-server -D  // 启动devServer
...
这时候执行npm run build后，会生成打包好的两个js文件，
